...
/// @notice implements ERC721 for transferable tradable non fungible supply positions
/// @dev based on OpenZeppelin's implementation
contract SupplyPositionFacet is IERC721 {
    ...
    function safeMint(address to) external onlySelf {
        SupplyPosition storage sp = supplyPositionStorage();

        sp.totalSupply++;
        _safeMint(to, sp.totalSupply);
    }
